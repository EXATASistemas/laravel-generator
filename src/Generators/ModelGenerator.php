...
class ModelGenerator extends BaseGenerator
{
    ...
    /**
     * Adriano 22/10/2017
     * Função usada para gerar o muttators do modelo , trocando o valor nulo por
     * valor vazio.Esta função foi baseada na função generateCasts e é usada na função
     * fillTemplate.Para ter efeito é nescessário que o template do modelo em
     * resources/infyom/infyom-generator-templates/model/model.stub
     * tenha o marcador $MUTATORS$
     */
    ...
    {
        $value ? $this->attributes["'.$field->name.'"] = $value : $this->attributes["'.$field->name.'"] = ';
